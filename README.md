...
- [DAWA Semana 07](#dawa-semana-07)
  - [Tabla de contenido](#tabla-de-contenido)
  - [Stack y funcionalidades](#stack-y-funcionalidades)
    - [Backend](#backend)
    - [Frontend](#frontend)
    - [Funcionalidades principales](#funcionalidades-principales)
  - [Arquitectura general (mapa)](#arquitectura-general-mapa)
  - [Secuencias de negocio](#secuencias-de-negocio)
    - [1) Registro de usuario (`POST /api/auth/signUp`)](#1-registro-de-usuario-post-apiauthsignup)
    - [2) Inicio de sesión (`POST /api/auth/signIn`)](#2-inicio-de-sesión-post-apiauthsignin)
    - [3) Acceso a ruta protegida (`GET /api/users`)](#3-acceso-a-ruta-protegida-get-apiusers)
    - [4) Actualizacion de perfil (`PUT /api/users/me`)](#4-actualizacion-de-perfil-put-apiusersme)
  - [Estructura del proyecto](#estructura-del-proyecto)
  - [Mapa de rutas y seguridad](#mapa-de-rutas-y-seguridad)
  - [Mapa de navegacion frontend](#mapa-de-navegacion-frontend)
  - [Diagrama de datos (ER simplificado)](#diagrama-de-datos-er-simplificado)
  - [Requisitos](#requisitos)
  - [Instalación y ejecución](#instalación-y-ejecución)
  - [Variables de entorno](#variables-de-entorno)
  - [Semillas iniciales (roles y admin)](#semillas-iniciales-roles-y-admin)
  - [Modelo de datos](#modelo-de-datos)
    - [Colección `roles`](#colección-roles)
  ...
  - [API REST](#api-rest)
    ...
    - [Usuarios (protegido)](#usuarios-protegido)
      - [`GET /api/users`](#get-apiusers)
      - [`GET /api/users/me`](#get-apiusersme)
      - [`PUT /api/users/me`](#put-apiusersme)
      - [`GET /api/users/:id`](#get-apiusersid)
    - [Errores comunes](#errores-comunes)
  - [Ejemplos `curl` listos para probar](#ejemplos-curl-listos-para-probar)
    - [1) Registro](#1-registro)
    - [2) Login](#2-login)
    - [3) Listar usuarios (admin)](#3-listar-usuarios-admin)
    - [4) Perfil propio](#4-perfil-propio)
    - [5) Actualizar perfil](#5-actualizar-perfil)
  - [Vistas web y rutas](#vistas-web-y-rutas)
  - [Manejo de autenticación en frontend](#manejo-de-autenticación-en-frontend)
  - [Estados esperados por pantalla](#estados-esperados-por-pantalla)
    - [`signIn`](#signin)
    - [`signUp`](#signup)
  ...
  - [Evidencias y capturas de pantalla](#evidencias-y-capturas-de-pantalla)
  - [Troubleshooting](#troubleshooting)
    - [Mongo no conecta](#mongo-no-conecta)
    - [Siempre devuelve 401](#siempre-devuelve-401)
    - [Siempre devuelve 403 en admin](#siempre-devuelve-403-en-admin)
    - [Error de validación de contraseña](#error-de-validación-de-contraseña)
  - [Checklist de seguridad minima](#checklist-de-seguridad-minima)
  - [Guion de demo (5-8 minutos)](#guion-de-demo-5-8-minutos)
  - [Despliegue basico (referencial)](#despliegue-basico-referencial)
  - [FAQ rapido](#faq-rapido)
    - [Se pueden crear usuarios admin por API?](#se-pueden-crear-usuarios-admin-por-api)
    - [Por que se usa `sessionStorage`?](#por-que-se-usa-sessionstorage)
    - [Por que hay `adress` y no `address`?](#por-que-hay-adress-y-no-address)
